import deployment from '../../shared/mainnetDeployment.json';
...
export const manifestAddress=import.meta.env.VITE_MANIFEST_ADDRESS||deployment.manifestAddress;
...
export async function loadRom(source:CartridgeSource,report:(p:Progress)=>void,signal:AbortSignal){
 ...
 const pin=(source==='arbitrum'?arbitrumHash:(import.meta.env.VITE_ROM_HASH||deployment.compressedHash)) as Hex|undefined;
