...
export function Token(){return <section className="token-section" aria-labelledby="token-title">
 <div className="token-copy"><p className="eyebrow">TOKEN // ROBINHOOD CHAIN</p><h2 id="token-title">FUEL FOR THE <em>ARENA.</em></h2><p>DOOM.exe (DOOMEXE) is paired with MSFT on Robinhood Chain. View the trading pair or open Long to trade.</p></div>
