...
export default function App(){
 ...
 return <main>
  <header className="site-hero">
   <div className="hero-art"><img className="hero-image" src="/doom-exe-hell-header-clean.png" alt="DOOM.EXE — Hell has a new home. Play on Robinhood Chain."/></div>
